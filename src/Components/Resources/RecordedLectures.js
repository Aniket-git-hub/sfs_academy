...
import lecture16img from "../../Assets/img/lecture/lecture16ss.png";
import lecture17img from "../../Assets/img/lecture/lecture17ss.png";
...
const RecordedLectures = () => {
    ...
    const openLinkInNewTab16 = () => {
        const linkUrl = 'https://drive.google.com/file/d/1lFVwRBFMybaKuDAHEU7TkjT-fj_Qt_u3/view?usp=sharing';
        window.open(linkUrl, '_blank');
    };
    const openLinkInNewTab17 = () => {
        const linkUrl = 'https://drive.google.com/file/d/1TdPOPB9JtYyFEAVsYR8bqGY11XbFSIDH/view?usp=sharing';
        window.open(linkUrl, '_blank');
    };
    ...
    return (
        <div className="lectures">
            ...
            <div className="lecture-image">
                <div class="rcard">
                    <div class="rcard-details">
                        <p class="text-title">Lecture 16 (18-04-2024)</p>
                        <p class="text-body">
                            <img onClick={openLinkInNewTab16} src={lecture16img} width={300} height={200} />
                            <button onClick={openLinkInNewTab16} className="playButton">
                                ▶️
                            </button>
                        </p>
                    </div>
                    <button onClick={openLinkInNewTab16} class="rcard-button">Revise ▶️</button>
                </div>
            </div>
            <div className="lecture-image">
                <div class="rcard">
                    <div class="rcard-details">
                        <p class="text-title">Lecture 17 (18-04-2024)</p>
                        <p class="text-body">
                            <img onClick={openLinkInNewTab17} src={lecture17img} width={300} height={200} />
                            <button onClick={openLinkInNewTab17} className="playButton">
                                ▶️
                            </button>
                        </p>
                    </div>
                    <button onClick={openLinkInNewTab17} class="rcard-button">Revise ▶️</button>
                </div>
            </div>
